...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class LocomotionSetup : MonoBehaviour
    {
        ...
        TextMeshPro m_TurnSpeedLabel; [SerializeField]
        [Tooltip("The label that shows the current turn speed value.")]
        TextMeshProUGUI m_TurnSpeedLabel111;
        ...
        void InitializeControls()
        {
            ...
            m_TurnSpeedLabel.text = m_Manager.smoothTurnProvider.turnSpeed.ToString();
            _val = $"{m_Manager.smoothTurnProvider.turnSpeed.ToString(k_DegreeFormat)}{k_TurnSpeedUnitLabel}";
            m_TurnSpeedLabel111.text = $"{m_Manager.smoothTurnProvider.turnSpeed.ToString(k_DegreeFormat)}{k_TurnSpeedUnitLabel}";
